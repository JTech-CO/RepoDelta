...
파일·코드 보존·이미지·ZIP 검사 **34개 통과**. 설치 ZIP과 dist의 모든 파일이 바이트 단위로 일치합니다. 원본 SVG에 viewBox를 추가하기 전후의 412×412 렌더링 픽셀 차이는 0입니다. 원본 PNG의 Git blob 해시도 저장소와 일치합니다.

설치 ZIP SHA-256: `9ab048bd8b2906556f964ddf548f74c06485368fcafe78140aeab51fde5a8cdb`
